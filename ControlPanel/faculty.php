...
<script type="text/javascript" src="./files/jsapi">
      							...
      							function onLoad() {
										...
										control.makeTransliteratable(['designation']);
										control.makeTransliteratable(['designation1']);
										control.makeTransliteratable(['name1']);
	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "edit")
				...
				$existing_details_rs= mysqli_query($conn,$fetch_existing_details_query);
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
							 ...
							 <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">
                              Add New Faculty
							</button>		<a href="alumini/faculties.xls" class="btn btn-primary btn-lg"  onClick="save();">Export To XLS</a>
				...
				<table border=0 style="padding-bottom: 20px;" cellpadding="5" border="0" cellspacing="0" width="80%" height="210">
					   <tr>
						...
						<tr>
							...
							<td height="49"><b>:</b></td>
							<td height="49" width="755"><input name="name" type="text" class="form-control" id="name" /><br><DIV id="error_name" style="color:red;"></DIV></td>
							<td width="0" valign="top" height="49"></td>		
						</tr>
						...
						<tr>
							...
							<td height="41"><b>:</b></td>
							<td height="41" width="755"><input name="designation" type="text"  class="form-control" id="designation"  /><br><DIV id="error_designation" style="color:red;"></DIV></td>
							<td width="0" valign="top" height="41"></td>		
						</tr>
						...
						<tr>
							...
							<td height="41"><b>:</b></td>
							<td height="41" width="755"><input type="text" size="12" id="qualification" class="form-control" style="width:150px;" name="qualification"/><br><DIV id="error_qualification" style="color:red;"></DIV></td>
							<td width="0" valign="top" height="41"></td>		
						</tr>
