	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "save")
				...
				mysqli_query($conn,$news_insert) or die(mysqli_error());
			
				$log->info("News Data inserted");
					
				$message="DKKKPITIKALAMB.COM :: 1 News Inserted";
	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "delete")
				...
				$existing_photo_rs= mysqli_query($fetch_existing_photo_query);
				...
				mysqli_query($news_delete) or die(mysqli_error());
				$log->info("News Data Deleted");
				$message="DKKKPITIKALAMB.COM :: 1 News Deleted";
				?>
