	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "save")
				...
				if(move_uploaded_file($_FILES['photo']['tmp_name'],$target_path))
					...
					mysqli_query($conn,$gallery_insert) or die(mysql_error());
				
					$log->info("Gallery Data inserted");
					
					$message="DKKKPITIKALAMB.COM :: 1 Photo Inserted";
	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "delete")
				...
				mysqli_query($conn,$gallery_delete) or die(mysqli_error());
				$log->info("Gallery  Data Deleted");
				$message="DKKKPITIKALAMB.COM :: 1 Photo Deleted";
