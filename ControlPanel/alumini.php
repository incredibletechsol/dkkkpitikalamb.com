                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <h3>List Of Aluminis</h3>
								<div align='right'>	
								<a href="alumini/aluminis.xls" class="btn btn-primary"  onClick="save();">Export To XLS</a>
								<?php include("excel.php"); listOfAluminis(); ?>
								</div>
					    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										include('conn.php');
										$fetch_alumini_details="select * from tbl_alumini order by id desc";	
										
										$alumini_details_rs= mysqli_query($conn,$fetch_alumini_details);

										while($alumini_details_row = mysqli_fetch_array($alumini_details_rs)) 
											{
											$id=$alumini_details_row[0];
											echo "<tr>";
											echo "<td>".$alumini_details_row[1]."</td>";
											echo "<td>".$alumini_details_row[2]."</td>";
											echo "<td>".$alumini_details_row[3]."</td>";
											echo "<td>".$alumini_details_row[4]."</td>";
											echo "<td>".$alumini_details_row[5]."</td>";
											echo "<td>".$alumini_details_row[6]."</td>";
											echo "<td><a href='aluminiactions.php?id=$id&msg=delete'><img src='images/cross.png' border='0'></a></td>";
											echo "</tr>";
											} 
										?>
                                    </tbody>
